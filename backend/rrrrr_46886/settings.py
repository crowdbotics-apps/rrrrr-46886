"""
Django settings for rrrrr_46886 project.
...
WSGI_APPLICATION = 'rrrrr_46886.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rrrrr_46886 API",
    "DESCRIPTION": "API documentation for rrrrr_46886 App",
    "VERSION": "v1",
}
